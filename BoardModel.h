...
public:
    ...
    explicit BoardModel(int size, QObject *parent = nullptr);
...
signals:
    ...
    void hexStateChanged(int row, int col, BoardModel::HexState newState); // Specific hex change
    void currentPlayerChanged();
    void gameOverChanged();
    void unitMoved(int fromRow, int fromCol, int toRow, int toCol); // For future unit movement
